...
- `versionStaffingShift()` and `versionRotationPattern()` — the archive-and-create transactions — remain untested (OI-103). No capacity test currently mocks the database, so this needs a new fixture pattern. Both were verified manually end-to-end against the dev database
